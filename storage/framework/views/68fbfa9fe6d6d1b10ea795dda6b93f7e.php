                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action=<?php echo e(Route('umum.hc.update', $hc->id)); ?> enctype="multipart/form-data"
                                method="post">
                                <?php echo csrf_field(); ?>
                                <div class="table-responsive">
                                    <table class="table table-borderless p-1">
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    class="form-control"
                                                    id="nama_lengkap" name="nama_lengkap" value="<?php echo e($hc->nama_lengkap); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Alamat</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                                    class="form-control"
                                                    value="<?php echo e($hc->tanggal_lahir); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="email" id="email"
                                                    class="form-control"
                                                     name="email" value="<?php echo e($hc->email); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="warga"
                                                    class="form-control"
                                                     value="<?php echo e($hc->kewarganegaraan); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="pos"
                                                ...
                                                <input type="text"
                                                    class="form-control"
                                                     value="<?php echo e($hc->institusi); ?>" name="institusi"
                                                    hidden>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                id="uraian" name="uraian_singkat" id="floatingTextarea2" style="height: 150px"><?php echo e($hc->uraian_singkat); ?></textarea>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/hakcipta/edit/content.blade.php ENDPATH**/ ?>