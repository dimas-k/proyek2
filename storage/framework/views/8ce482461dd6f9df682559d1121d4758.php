                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-select" aria-label="Default select example" name="jurusan" id="jurusan">
                                                    ...
                                                    <option value="Teknik Informatika" <?php echo e(old('jurusan',$di->jurusan) == 'Teknik Informatika' ? 'selected' : ''); ?>>Teknik Informatika</option>
                                                    <option value="Teknik" <?php echo e(old('jurusan', $di->jurusan) == 'Teknik' ? 'selected' : ''); ?>>Teknik</option>
                                                    <option value="Kesehatan" <?php echo e(old('jurusan', $di->jurusan) == 'Kesehatan' ? 'selected' : ''); ?>>Kesehatan</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-select" aria-label="Default select example" name="prodi" id="prodi">
                                                    ...
                                                    <option value="D3 Teknik Informatika" <?php echo e(old('prodi', $di->prodi) == 'D3 Teknik Informatika' ? 'selected' : ''); ?>>D3 Teknik Informatika</option>
                                                    <option value="D4 Rekayasa Perangkat Lunak" <?php echo e(old('prodi', $di->prodi) == 'D4 Rekayasa Perangkat Lunak' ? 'selected' : ''); ?>>D4 Rekayasa Perangkat Lunak</option>
                                                    <option value="D4 Sistem Informasi Kota Cerdas" <?php echo e(old('prodi', $di->prodi) == 'D4 Sistem Informasi Kota Cerdas' ? 'selected' : ''); ?>>D4 Sistem Informasi Kota Cerdas</option>
                                                    <option value="D3 Teknik Mesin" <?php echo e(old('prodi', $di->prodi) == 'D3 Teknik Mesin' ? 'selected' : ''); ?>>D3 Teknik Mesin</option>
                                                    <option value="D4 Perancangan Manufaktur" <?php echo e(old('prodi', $di->prodi) == 'D4 Perancangan Manufaktur' ? 'selected' : ''); ?>>D4 Perancangan Manufaktur</option>
                                                    <option value="D3 Teknik Pendingin dan Tata Udara" <?php echo e(old('prodi', $di->prodi) == 'D3 Teknik Pendingin dan Tata Udara' ? 'selected' : ''); ?>>D3 Teknik Pendingin dan Tata Udara</option>
                                                    <option value="D4 Teknologi Rekayasa Instrumentasi dan Kontrol" <?php echo e(old('prodi', $di->prodi) == 'D4 Teknologi Rekayasa Instrumentasi dan Kontrol' ? 'selected' : ''); ?>>D4 Teknologi Rekayasa Instrumentasi dan Kontrol</option>
                                                    <option value="D3 Keperawatan" <?php echo e(old('prodi', $di->prodi) == 'D3 Keperawatan' ? 'selected' : ''); ?>>D3 Keperawatan</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
