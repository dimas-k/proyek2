...
<body>
    ...
    <div class="container search-container">
        ...
        <div class="rounded border shadow-sm p-3 mb-4 mt-3">
            <form action="/hak-cipta/list/pegawai/cari" method="POST" class="search-form d-flex align-items-center">
                ...
                <select id="nama" class="form-select form-select-sm select2 flex-grow-1" name="nama"
                    ...
                    <option></option>
                    <?php $__currentLoopData = $orang->unique('nama_lengkap'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($o->nama_lengkap); ?>"><?php echo e($o->nama_lengkap); ?></option>
        ...
        <div class="rounded border shadow-sm p-4 mb-5">
            <h3 class="fw-normal font-family-Kokoro mb-3"><i class="bi bi-table me-2"></i>Daftar Hak Cipta <b>
                    <?php $__currentLoopData = $orang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($jur->nama_lengkap); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover font-family-Kokoro">
                ...
                <tbody>
                    <?php $__currentLoopData = $orang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th scope="row">
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/umum-page/Hakcipta/perorangan/cari.blade.php ENDPATH**/ ?>