...
unset($__errorArgs, $__bag); ?>" id=""
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control"
                                            placeholder="Masukkan Judul Desain Industri" name="judul_di" value="<?php echo e(old('judul_di')); ?>" id="judul_desain">
                                    </div>
                                    <div class="mb-3">
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/dosen/desainindustri/pengajuan/content.blade.php ENDPATH**/ ?>