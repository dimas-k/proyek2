...
<head>
    ...
    <title>SIKI POLINDRA || Desain Industri Pegawai</title>
</head>
...
<body>
    ...
    <div class="container search-container">
        <a href="/desain-industri" class="link-dark link-underline link-underline-opacity-0 mb-3"><i class="bi bi-arrow-left-circle" style="font-size: 2rem;"></i></a>
        <div class="rounded border shadow-sm p-3 mb-4 mt-3">
            <form action="/desain-indstri/list/pegawai/cari" method="POST" class="search-form d-flex align-items-center">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/umum-page/Desainindustri/perorangan/index.blade.php ENDPATH**/ ?>