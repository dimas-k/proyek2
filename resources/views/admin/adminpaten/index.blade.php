                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ Route('admin_paten.update', $p->id) }}"
                                                                ...
                                                                <div class="container">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            name="kode_pos" value={{ $p->kode_pos }}>
                                                                        @error('kode_pos')
                                                                            <div class="invalid-feedback">
                                                                                {{ $message }}
                                                                            </div>
                                                                ...
                                                                <div class="container">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for=""
                                                                            class="form-label">Pengalihan Hak
                                                                            Invensi</label>
                                                                        <input type="file"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for=""
                                                                            class="form-label">Pernyataan kepemikikan
                                                                            Inventor</label>
                                                                        <input type="file"
