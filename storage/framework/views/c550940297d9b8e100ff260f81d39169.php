...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Dosen | Paten</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('dosen.paten.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
</html><?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/dosen/paten/index.blade.php ENDPATH**/ ?>