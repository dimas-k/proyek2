                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="p-2" enctype="multipart/form-data" method="post"
                                action="/dosen/pengajuan/paten/simpan">
                                @csrf
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="" placeholder="Masukkan Kode Pos" name="kode_pos" value="{{ old('kode_pos') }}">
                                        @error('kode_pos')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="" placeholder="Masukkan Judul Paten" name="judul_paten" value="{{ old('judul_paten') }}">
                                        @error('judul_paten')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
