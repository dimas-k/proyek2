                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" method="post"
                                action="/umum/desain-industri/pengajuan/simpan" id="uploadForm">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="warga"
                                            ...
                                            value="<?php echo e(old('kewarganegaraan')); ?>">
                                    ...
                                    <input type="text"
                                        class="form-control <?php $__errorArgs = ['institusi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="<?php echo e(old('judul_di')); ?>" id="judul_desain">
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/desainindustri/pengajuan/content.blade.php ENDPATH**/ ?>