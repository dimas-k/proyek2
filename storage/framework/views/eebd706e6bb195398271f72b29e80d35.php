                        ...
                        <div class="container">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_lengkap"
                                    placeholder="Masukkan Nama"name="nama_lengkap" value="<?php echo e($p->nama_lengkap); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="jurusan"
                                    ...
                                    <option value="Teknik"
                                        <?php echo e(old('jurusan', $p->jurusan) == 'Teknik' ? 'selected' : ''); ?>>Teknik</option>
                                    <option value="Kesehatan"
                                        <?php echo e(old('jurusan', $p->jurusan) == 'Kesehatan' ? 'selected' : ''); ?>>Kesehatan
                                    </option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="prodi"
                                    ...
                                    <option value="D3 Teknik Informatika"
                                        <?php echo e(old('prodi', $p->prodi) == 'D3 Teknik Informatika' ? 'selected' : ''); ?>>D3
                                        Teknik Informatika</option>
                                    ...
                                    <option value="D3 Teknik Mesin"
                                        <?php echo e(old('prodi', $p->prodi) == 'D3 Teknik Mesin' ? 'selected' : ''); ?>>D3 Teknik
                                        Mesin</option>
                                    ...
                                    <option value="D3 Keperawatan"
                                        <?php echo e(old('prodi', $p->prodi) == 'D3 Keperawatan' ? 'selected' : ''); ?>>D3
                                        Keperawatan</option>
                                </select>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/admin/adminpaten/editpaten/index.blade.php ENDPATH**/ ?>