        ...
        <div class=" p-4 mt-3 ">
            ...
            <div class="table-responsive">
                <table class="table table-borderless p-1">
                    ...
                    <tr>
                        <th>Email</th>
                        <td>: <a href="mailto:<?php echo e($hc->email); ?>"><?php echo e($hc->email); ?></a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            : <a href=<?php echo e(asset('storage/' . $hc->dokumen_invensi)); ?> class=""
                                target="_blank">Lihat Dokumen Invensi</a>
                        </td>
                    </tr>
                    <tr>
                        <th>Tanggal pengajuan</th>
                        <td>: <?php echo e($hc->tanggal_permohonan); ?></td>
                    </tr>
                    <tr>
                        <th>Status</th>
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/hcshow/index.blade.php ENDPATH**/ ?>