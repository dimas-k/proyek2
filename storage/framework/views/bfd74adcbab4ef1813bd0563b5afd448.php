            ...
            <div class="col-lg-10 mt-2">
                <div class="container bg-light rounded border pt-3">
                    <h3 class="fw-normal font-family-Kokoro mb-3">
                        <i class="bi bi-file-earmark me-2"></i>Data Hak Cipta <?php echo e($di->nama_lengkap); ?>

                    </h3>
                    <hr class="border border-black border-2 opacity-75">
                    <form enctype="multipart/form-data" method="post"
                        action=<?php echo e(route('adm.update-di.dosen', $di->id)); ?> id="uploadForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="container">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_lengkap"
                                    placeholder="Masukkan Nama"name="nama_lengkap" value="<?php echo e($di->nama_lengkap); ?>"
                                    readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alamat" placeholder="Masukkan Alamat"
                                    name="alamat" value="<?php echo e($di->alamat); ?>">
                                
                            </div>
                            <div class="mb-3">
                                <label for="no_telepon" class="form-label">No telepon</label>
                                <input type="number" class="form-control " id="no_telepon"
                                    placeholder="Masukkan No telepon" name="no_telepon" value="<?php echo e($di->no_telepon); ?>">
                                
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_lahie" class="form-label">Tanggal Lahir</label>
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control"
                                    value="<?php echo e($di->tanggal_lahir); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control " id="email" placeholder="Masukkan Email"
                                    name="email" value="<?php echo e($di->email); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="warga"
                                    ...
                                    value="<?php echo e($di->kewarganegaraan); ?>">
                                
                            </div>
                            <div class="mb-3">
                                <label for="pos" class="form-label">Kode Pos</label>
                                <input type="number" class="form-control" id="pos"
                                    placeholder="Masukkan Kode Pos" name="kode_pos" value="<?php echo e($di->kode_pos); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" aria-label="Default select example"
                                            ...
                                            <option value="Teknik"
                                                <?php echo e(old('jurusan', $di->jurusan) == 'Teknik' ? 'selected' : ''); ?>>Teknik
                                            </option>
                                    ...
                                    <td>
                                        <select class="form-select" aria-label="Default select example"
                                            ...
                                            <option value="D3 Keperawatan"
                                                <?php echo e(old('prodi', $di->prodi) == 'D3 Keperawatan' ? 'selected' : ''); ?>>D3
                                                Keperawatan</option>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <div class="container">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" placeholder="" name="surat_pengalihan"
                                    id="pengalihan" value="<?php echo e($di->surat_pengalihan); ?>">
                                <span class="text-danger"><i class="bi bi-exclamation-triangle-fill me-2"
                                        data-bs-toggle="tooltip"></i>File harus bertipe .pdf dan tidak lebih dari
                                    10mb</span>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/admin/admindi/editdi/dosen.blade.php ENDPATH**/ ?>