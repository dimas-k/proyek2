        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="paten.html">Paten</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="hakcipta.html">Hak Cipta</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="desainindustri.html">Desain Industri</a>
              </li>
              ...
              <div class="row">
                <div class="col-md-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Sistem Informasi Kekayaan Intelektual POLINDRA (Sistem Informasi KI POLINDRA) merupakan media informasi perkembangan permohonan KI yang dikelola oleh POLINDRA. Para pemangku kepentingan di POLINDRA, inventor, dan masyarakat luas dapat mengakses dan melihat perkembangan permohonan KI POLINDRA melalui Sistem Informasi KI POLINDRA.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Baca Selengkapnya
    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            Berikut adalah informasi tentang Paten, Hak Cipta, Dan Desain Industri
          </p>
        </div>
        <div class="row">
          <div class="col-md-4 ">
          ...
          <div class="info_contact">
            ...
            <div class="contact_link_box">
              <a href="">
                ...
                <span>
                  Jl. Raya Lohbener Lama No. 08 Kec. Lohbener Kab. Indramayu 45252 Jawa Barat
                </span>
              </a>
              <a href="">
        ...
        <div class="col-md-6 col-lg-2 mx-auto info_col">
          <div class="info_link_box">
            ...
            <div class="info_links">
              ...
              <a class="" href="paten.html">
                Paten
              </a>
              <a class="" href="hakcipta.html">
                Hak Cipta
              </a>
              <a class="" href="desainindustri.html">
                Desain Industri
              </a>
            </div>
          </div>
  ...
  <section class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Politeknik Negeri Indramayu</a>
      </p>
    </div>
  </section>
  <!-- footer section -->
