            ...
            <table class="table table-hover font-family-Kokoro">
                ...
                <tbody>
                    <?php $__currentLoopData = $prodi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th scope="row"><?php echo e(($prodi->currentPage() - 1) * $prodi->perPage() + $loop->iteration); ?></th>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum-page/paten/prodi/cari.blade.php ENDPATH**/ ?>