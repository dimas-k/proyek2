    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Update Nilai Paten</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/checker/cek/hak-cipta">Cek Paten</a></li>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action={{ route('update.cek.paten', ['id'=>request()->segment(6)]) }} enctype="multipart/form-data"
                                method="post">
                                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                    ...
                                                    id="" name="keterangan" value="{{ $paten->keterangan }}">
                                                @error('keterangan')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
