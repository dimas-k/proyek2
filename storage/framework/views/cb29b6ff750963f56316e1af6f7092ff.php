                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-borderless p-1">
                                    ...
                                    <tr>
                                        <th>KTP</th>
                                        <td>: <a href="<?php echo e(route('private_di_dosen', ['file' => basename($di->ktp_inventor)])); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <?php if($di->data_pengaju2): ?>
                                            <a href="<?php echo e(route('private_di_dosen', ['file' => basename($di->data_pengaju2)])); ?>" target="_blank">Download xlsx Anggota Inventor</a>
                                        <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td >: <a href="<?php echo e(route('public_di_dosen', ['filename' => basename($di->gambar_di)])); ?> "
                                            target="_blank">Lihat Gambar Desain Industri</a></td>
                                    </tr>
                                    <tr>
                                        <th>Uraian Desain Industri</th>
                                        <td>: <a href="<?php echo e(route('public_di_dosen', ['filename' => basename($di->uraian_di)])); ?>"
                                                target="_blank">Lihat Uraian Desain Industri</a></td>
                                    </tr>
                                    <tr>
                                        <th>surat Kepemilikan</th>
                                        <td>: <a href=<?php echo e(route('private_di_dosen', ['file' => basename($di->surat_kepemilikan)])); ?> class=""
                                                target="_blank">Lihat Surat Kepemilikan</a></td>
                                    </tr>
                                    <tr>
                                        <th>Surat Pengalihan hak</th>
                                        <td>: <a href="<?php echo e(route('private_di_dosen', ['file' => basename($di->surat_pengalihan)])); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>: <?php if($di->sertifikat_desain != ""): ?>
                                                <a href="<?php echo e(route('private_di_dosen', ['file' => basename($di->sertifikat_desain)])); ?>""
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/dosen/desainindustri/lihat/content.blade.php ENDPATH**/ ?>