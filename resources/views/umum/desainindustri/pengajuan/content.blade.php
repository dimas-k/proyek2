                            ...
                            <form enctype="multipart/form-data" method="post" action="/umum/desain-industri/pengajuan/simpan">
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('no_telepon') is-invalid @enderror" id=""
                                            placeholder="Masukkan No telepon" name="no_telepon" value="{{ auth()->user()->no_telepon }}">
                                        @error('no_telepon')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control @error('ktp_inventor') is-invalid @enderror"
                                            id="" name="ktp_inventor" value="{{ old('ktp_inventor') }}">
                                ...
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('judul_di') is-invalid @enderror" placeholder="Masukkan Judul Desain Industri" name="judul_di" value="{{ old('judul_di') }}">
                                        @error('judul_di')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal_permohonan" id="tanggalpengajuan" class="form-control @error('tanggal_permohonan') is-invalid @enderror" value="{{ old('tanggal_permohonan') }}">
