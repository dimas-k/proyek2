                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($desainDPU); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($desainKBL); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $di; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($d->cekDi?->keterangan == null): ?>
                                                ...
                                                <td><a href=<?php echo e(Route('umum.di.lihat', $d->id)); ?>

                                                        class="btn btn-info"><i class="fa fa-eye" data-bs-toggle="tooltip"></i></a>
                                                    <a href=<?php echo e(Route('umum.di.edit', $d->id)); ?>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/desainindustri/content.blade.php ENDPATH**/ ?>