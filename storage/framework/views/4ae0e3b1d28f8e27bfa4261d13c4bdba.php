    ...
    <div class="container d-flex justify-content-center align-items-center mt-5 mb-5" style="min-height: 80vh;">
        <div class="col-12 col-md-8 col-lg-5">
            <div class="card bg-light p-4">
                ...
                <form method="post" action="<?php echo e(route('simpan.akun')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kerjaan" class="form-control" value="<?php echo e(old('kerjaan')); ?>">
                    </div>
                    <div class="mb-3">
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/login-user/regist/other/index.blade.php ENDPATH**/ ?>