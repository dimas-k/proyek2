        ...
        <div class="rounded border shadow-sm p-3 mb-4 mt-3">
            <form action="/desain-indstri/list/pegawai/cari" method="POST"
                ...
                <select id="nama" class="form-select form-select-sm select2 flex-grow-1" name="nama"
                    ...
                    <option></option>
                    <?php $__currentLoopData = $nama->unique('nama_lengkap'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="rounded border shadow-sm p-3 mb-5">
            ...
            <div class="table-responsive">
                <table class="table table-hover font-family-Kokoro">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $orang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $or): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <th scope="row">
                                    <?php echo e(($orang->currentPage() - 1) * $orang->perPage() + $loop->iteration); ?>

                                </th>
                                <td><?php echo e($or->nama_lengkap); ?></td>
                                <td><?php echo e($or->jenis_di); ?></td>
                                <td><?php echo e($or->judul_di); ?></td>
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/umum-page/Desainindustri/perorangan/cari.blade.php ENDPATH**/ ?>