...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            @include('dosen.paten.pengajuan.content')
            <!--app-content close-->
        ...
        $(document).ready(function() {
            $('#uploadForm').submit(function(e) {
                ...
                for (var file in files) {
                    if (file === 'anggota_inventor') {
                        // Check if anggota_inventor is empty or valid
                        if (!files[file]) {
                            showError("Tolong Masukkan " + file.replace('_', ' ').toUpperCase() + " Anda!");
                            return false;
                        } else if (!allowedExtensionExcel.exec(files[file].name)) {
