                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($catat); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($pf); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($mt); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($mp); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($mps); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($stak); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"> <?php echo e($stl); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font"><?php echo e($staw); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex">
                                    <div class="mt-2">
                                        <h6 class="">Menunggu Tanggapan substansif
                                            <h2 class="mb-0 number-font"><?php echo e($mts); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $paten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td> <?php if($p->cek?->cek_data == 'Valid'): ?>
                                                ...
                                                <?php else: ?>
                                                    <i class="fa fa-minus-circle" style="color: yellow"
                                                        data-bs-toggle="tooltip"></i>
                                                <?php endif; ?></td>
                                                <td><?php if($p->cek?->keterangan == null): ?>
                                                    Data Paten Belum Diverifikasi
                                                <?php else: ?>
                                                    <?php echo e($p->cek?->keterangan); ?>

                                                <?php endif; ?></td>
                                                <td><a href=<?php echo e(Route('umum.paten.lihat', $p->id)); ?>

                                                        class="btn btn-info"><i class="bi bi-eye"></i></a>
                                                    <a href=<?php echo e(Route('umum.paten.edit', $p->id)); ?>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/paten/content.blade.php ENDPATH**/ ?>