...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Dosen | Pengajuan Paten</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('dosen.paten.pengajuan.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/dosen/paten/pengajuan/index.blade.php ENDPATH**/ ?>