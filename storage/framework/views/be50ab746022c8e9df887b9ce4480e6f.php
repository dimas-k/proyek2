                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $hc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><a href=<?php echo e(Route('umum.hc.lihat', $p->id)); ?>

                                                        class="btn btn-info"><i class="fa fa-eye"
                                                            data-bs-toggle="tooltip"></i></a>
                                                    <a href=<?php echo e(Route('umum.hc.edit', $p->id)); ?>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/hakcipta/content.blade.php ENDPATH**/ ?>