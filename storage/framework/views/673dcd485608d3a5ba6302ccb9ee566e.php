...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Checker | Update Nilai Paten</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('checker.cekpaten.update.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
</html><?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/checker/cekpaten/update/index.blade.php ENDPATH**/ ?>