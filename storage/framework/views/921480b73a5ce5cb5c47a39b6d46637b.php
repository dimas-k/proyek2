        ...
        <div class="row">
            ...
            <div class="col-lg-10 mt-2">
                <div class="container bg-light rounded border pt-3">
                    ...
                    <form enctype="multipart/form-data" method="post" action=<?php echo e(route('admin_hakcipta.update_umum', $hk->id)); ?>
                        ...
                        <div class="container">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control " id="nama_lengkap"
                                    placeholder="Masukkan Nama"name="nama_lengkap" value="<?php echo e($hk->nama_lengkap); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control " id="ktp" name="ktp_inventor"
                                    value="<?php echo e($hk->ktp_inventor); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="jenis_ciptaan" id="jenis_ciptaan">
                                            ...
                                            <option value="Karya Tulis" <?php echo e(old('jenis_ciptaan', $hk->jenis_ciptaan) == 'Karya Tulis' ? 'selected' : ''); ?>>Karya Tulis</option>
                                            <option value="Program Komputer" <?php echo e(old('jenis_ciptaan', $hk->jenis_ciptaan) == 'Program Komputer' ? 'selected' : ''); ?>>Program Komputer</option>
                                            <option value="Karya Lainnya" <?php echo e(old('jenis_ciptaan', $hk->jenis_ciptaan) == 'Karya Lainnya' ? 'selected' : ''); ?>>Karya Lainnya</option>
                                        </select>
                                    </td>
                                </tr>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/admin/adminhk/edithk/umum.blade.php ENDPATH**/ ?>