            ...
            <div class="col-lg-10 mt-2">
                <div class="container bg-light rounded border pt-3">
                    ...
                    <form class="p-2" enctype="multipart/form-data" method="post"
                        action=<?php echo e(route('adm.update-data-paten', $p->id)); ?> id="uploadForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="warga"
                                    placeholder="Masukkan Kewarganegaraan" name="kewarganegaraan" value="<?php echo e($p->kewarganegaraan); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="jurusan" id="jurusan">
                                    ...
                                    <option value="Teknik Informatika" <?php echo e(old('jurusan',$p->jurusan) == 'Teknik Informatika' ? 'selected' : ''); ?>>Teknik Informatika</option>
                                    <option value="Teknik" <?php echo e(old('jurusan', $p->jurusan) == 'Teknik' ? 'selected' : ''); ?>>Teknik</option>
                                    <option value="Kesehatan" <?php echo e(old('jurusan', $p->jurusan) == 'Kesehatan' ? 'selected' : ''); ?>>Kesehatan</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="prodi" id="prodi">
                                    ...
                                    <option value="D3 Teknik Informatika" <?php echo e(old('prodi', $p->prodi) == 'D3 Teknik Informatika' ? 'selected' : ''); ?>>D3 Teknik Informatika</option>
                                    <option value="D4 Rekayasa Perangkat Lunak" <?php echo e(old('prodi', $p->prodi) == 'D4 Rekayasa Perangkat Lunak' ? 'selected' : ''); ?>>D4 Rekayasa Perangkat Lunak</option>
                                    <option value="D4 Sistem Informasi Kota Cerdas" <?php echo e(old('prodi', $p->prodi) == 'D4 Sistem Informasi Kota Cerdas' ? 'selected' : ''); ?>>D4 Sistem Informasi Kota Cerdas</option>
                                    <option value="D3 Teknik Mesin" <?php echo e(old('prodi', $p->prodi) == 'D3 Teknik Mesin' ? 'selected' : ''); ?>>D3 Teknik Mesin</option>
                                    <option value="D4 Perancangan Manufaktur" <?php echo e(old('prodi', $p->prodi) == 'D4 Perancangan Manufaktur' ? 'selected' : ''); ?>>D4 Perancangan Manufaktur</option>
                                    <option value="D3 Teknik Pendingin dan Tata Udara" <?php echo e(old('prodi', $p->prodi) == 'D3 Teknik Pendingin dan Tata Udara' ? 'selected' : ''); ?>>D3 Teknik Pendingin dan Tata Udara</option>
                                    <option value="D4 Teknologi Rekayasa Instrumentasi dan Kontrol" <?php echo e(old('prodi', $p->prodi) == 'D4 Teknologi Rekayasa Instrumentasi dan Kontrol' ? 'selected' : ''); ?>>D4 Teknologi Rekayasa Instrumentasi dan Kontrol</option>
                                    <option value="D3 Keperawatan" <?php echo e(old('prodi', $p->prodi) == 'D3 Keperawatan' ? 'selected' : ''); ?>>D3 Keperawatan</option>
                                </select>
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/admin/adminpaten/editpaten/index.blade.php ENDPATH**/ ?>