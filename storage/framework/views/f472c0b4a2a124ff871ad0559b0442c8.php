                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover p-1">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $di; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($p->cekDi?->cek_data == 'Valid'): ?>
                                                        <i class="fa fa-check-circle" style="color: green"
                                                            data-bs-toggle="tooltip"></i>
                                                    <?php elseif($p->cekDi?->cek_data == 'Tidak Valid'): ?>
                                                ...
                                                <td>
                                                    <?php if($p->cekDi?->keterangan == null): ?>
                                                        Data Desain Industri Belum Diverifikasi
                                                    <?php else: ?>
                                                        <?php echo e($p->cekDi?->keterangan); ?>

                                                    <?php endif; ?>
                                                </td>
                                                <td><a href=<?php echo e(Route('lihat.desain', $p->id)); ?>
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/checker/cekdi/content.blade.php ENDPATH**/ ?>