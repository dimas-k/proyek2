                ...
                <div class="container bg-light rounded border pt-3">
                    ...
                    <div class="table-responsive p-3 ">
                        <table class="table table-borderless p-1">
                            ...
                            <tr>
                                <th>Tanggal lahir</th>
                                <td>: <?php echo e($di->tanggal_lahir); ?></td>
                            </tr>
                            <tr>
                                <th>KTP</th>
                                <td>: <a href=<?php echo e(route('private_di', ['file' => basename($di->ktp_inventor)])); ?> class=""
                            ...
                            <tr>
                                ...
                                <?php if($di->data_pengaju2): ?>
                                    <a href="<?php echo e(route('private_di', ['file' => basename($di->data_pengaju2)])); ?>" target="_blank">Download xlsx Anggota Inventor</a>
                                <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>: <a href=<?php echo e(route('public_di', ['file' => basename($di->gambar_di)])); ?> class=""
                                        target="_blank">Lihat Gambar Desain Industri</a></td>
                            </tr>
                            <tr>
                                <th>Uraian Desain Industri</th>
                                <td>: <a href=<?php echo e(route('public_di', ['file' => basename($di->uraian_di)])); ?> class=""
                                        target="_blank">Lihat Uraian Desain Industri</a></td>
                            </tr>
                            <tr>
                                <th>surat Kepemilikan</th>
                                <td>: <a href=<?php echo e(route('private_di', ['file' => basename($di->surat_kepemilikan)])); ?> class=""
                                        target="_blank">Lihat Surat Kepemilikan</a></td>
                            </tr>
                            <tr>
                                <th>Surat Pengalihan Hak</th>
                                <td>: <a href=<?php echo e(route('private_di', ['file' => basename($di->surat_pengalihan)])); ?> class=""
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/admin/admindi/showdi/index.blade.php ENDPATH**/ ?>