                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="align-self-center">
                                    <h3 class="ms-5 d-flex justify-content-end"><?php echo e($tercatat); ?>
                    ...
                    <a href="/hak-cipta/keterangan-belum-lengkap"
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="align-self-center">
                                    <h3 class="ms-4 d-flex justify-content-end pe-2"><?php echo e($null); ?>
                    ...
                    <a href="/hak-cipta/menunggu-verifikasi" class="link-dark link-underline link-underline-opacity-0">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="align-self-center">
                                    <h3 class="ms-4 d-flex justify-content-end pe-2"><?php echo e($mvdov); ?>
        ...
        <table class="table table-hover font-family-Kokoro">
            ...
            <tbody>
                <?php $__currentLoopData = $hc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><?php echo e(($hc->currentPage() - 1) * $hc->perPage() + $loop->iteration); ?></th>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="hc2020" value="<?php echo e($hc2020); ?>">
                        <input type="hidden" id="hc2021" value="<?php echo e($hc2021); ?>">
                        <input type="hidden" id="hc2022" value="<?php echo e($hc2022); ?>">
                        <input type="hidden" id="hc2023" value="<?php echo e($hc2023); ?>">
                        <input type="hidden" id="hc2024" value="<?php echo e($hc2024); ?>">
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum-page/Hakcipta/index.blade.php ENDPATH**/ ?>