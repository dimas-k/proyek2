                ...
                <div class="container bg-light rounded border pt-3">
                    ...
                    <div class="table-responsive p-3">
                        <table class="table table-borderless rounded">
                            ...
                            <tr>
                                <th>KTP</th>
                                <td>: <a href=<?php echo e(route('private_paten_dosen', ['file' => basename($p->ktp_inventor)])); ?> class=""
                            ...
                            <tr>
                                ...
                                <?php if($p->data_pengaju2): ?>
                                    <a href="<?php echo e(asset('storage/' . $p->data_pengaju2)); ?>" target="_blank">Download xlsx Anggota Inventor</a>
                                <?php else: ?>
                            ...
                            <tr>
                                <th>Abstrak Paten</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->abstrak_paten)); ?> class=""
                                        target="_blank">Lihat Abstrak Paten</a></td>
                            </tr>
                            <tr>
                                <th>Deskripsi Paten</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->deskripsi_paten)); ?> class=""
                                        target="_blank">Lihat Deskripsi Paten</a></td>
                            </tr>
                            <tr>
                                <th>Pengalihan hak invensi</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->pengalihan_hak)); ?> class=""
                                        target="_blank">Lihat Pengalihan Hak Invensi</a></td>
                            </tr>
                            <tr>
                                <th>Klaim</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->klaim)); ?> class="" target="_blank">Lihat
                                        Klaim</a></td>
                            </tr>
                            <tr>
                                <th>Pernyataan Kepemilikan</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->pernyataan_kepemilikan)); ?> class=""
                                        target="_blank">Lihat Pernyataan Kepemilikan</a></td>
                            </tr>
                            <tr>
                                <th>Surat Kuasa</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->surat_kuasa)); ?> class=""
                                        target="_blank">Lihat Surat Kuasa</a></td>
                            </tr>
                            <tr>
                                <th>Gambar Paten</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->gambar_paten)); ?> class=""
                                        target="_blank">Lihat Gambar paten</a></td>
                            </tr>
                            <tr>
                                <th>Gambar Tampilan</th>
                                <td>: <a href=<?php echo e(asset('storage/' . $p->gambar_tampilan)); ?> class=""
                            ...
                            <tr>
                                ...
                                <td>: <?php if($p->sertifikat_paten != ''): ?>
                                        <a href=<?php echo e(asset('storage/' . $p->sertifikat_paten)); ?> class=""
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/admin/adminpaten/showpaten/index.blade.php ENDPATH**/ ?>