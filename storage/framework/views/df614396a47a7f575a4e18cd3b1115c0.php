...
<head>
    ...
    <link id="theme" rel="stylesheet" type="text/css" media="all"
        href="<?php echo e(asset('assets-user/colors/color1.css')); ?>" />
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!-- app-Header -->
            <?php echo $__env->make('umum.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /app-Header -->

            <!--APP-SIDEBAR-->
            <?php echo $__env->make('umum.layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <!--app-content open-->
            <?php echo $__env->make('umum.hakcipta.pengajuan.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/hakcipta/pengajuan/index.blade.php ENDPATH**/ ?>