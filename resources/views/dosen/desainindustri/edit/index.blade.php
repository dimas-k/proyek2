...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            @include('dosen.desainindustri.edit.content')
            <!--app-content close-->
    ...
    {{-- <script>
        $(document).ready(function() {
            $('#uploadForm').submit(function(e) {
                ...
                const mandatoryFiles = ['ktp', 'abstrak', 'gambar_desain', 'uraian_desain', 'pernyataan_kepemilikan', 'pengalihan'];
