              ...
              <div class="card-body p-5">
                <form class="mb-md-5 mt-md-4 pb-5" enctype="multipart/form-data" method="post" action={{ route('simpan.akun') }}>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="text" id="username" name="nama_lengkap" class="form-control form-control @error('nama_lengkap') is-invalid @enderror" required required value="{{ old('nama_lengkap') }}">
                    @error('username')
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="text" id="pass" name="alamat" class="form-control form-control @error('alamat') is-invalid @enderror" requiredrequired value="{{ old('alamat') }}">
                    @error('alamat')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="number" id="pass" name="no_telepon" class="form-control form-control @error('no_telepon') is-invalid @enderror" required required value="{{ old('no_telepon') }}">
                    @error('no_telepon')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="email" id="pass" name="email" class="form-control form-control @error('email') is-invalid @enderror" required required value="{{ old('email') }}">
                    @error('email')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="text" id="pass" name="kerjaan" class="form-control form-control @error('kerjaan') is-invalid @enderror" required required value="{{ old('kerjaan') }}">
                    @error('kerjaan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <input type="text" id="pass" name="username" class="form-control form-control @error('username') is-invalid @enderror" required required value="{{ old('username') }}">
                    @error('username')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
