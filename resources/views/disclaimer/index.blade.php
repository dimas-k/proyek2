...
<body>
    ...
    <div class="container">
        ...
        <br>
        <ul>
            <li class="fs-6 fw-normal font-family-Kokoro">Disclaimer atau sangkalan ini berguna bagi kami sebagai
                perlindungan terhadap tuntutan hukum dari pihak-pihak yang kurang bertanggung jawab.</li>
            <li class="fs-6 fw-normal font-family-Kokoro">Semua informasi yang dimuat dalam Sistem Informasi Kekayaan
            ...
            <li class="fs-6 fw-normal font-family-Kokoro">Susunan (urutan) nama-nama inventor pada Sistem Informasi KI
            ...
            <li class="fs-6 fw-normal font-family-Kokoro">Gunakan situs ini sebagai referensi pengetahuan, bukan sebagai
                rujukan absolut/mutlak.</li>
            <li class="fs-6 fw-normal font-family-Kokoro">Dengan menggunakan situs ini, Anda mengakui dan menyetujui
        ...
        <span class="d-flex justify-content-center">
            <img src={{ URL('storage/imgdis.png') }} class="mb-5 mt-5">
        </span>
    </div>
