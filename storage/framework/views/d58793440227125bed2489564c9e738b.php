                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="/simpan" class="mt-3">
                                            ...
                                            <div class="form-outline form-white mb-4">
                                                ...
                                                <input type="text" id="" class="form-control <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-outline form-white mb-4">
                                                ...
                                                <input type="Password" id="" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <table class="table table-hover font-family-Kokoro">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href=<?php echo e(Route('admin.show', $a->id)); ?> class="btn btn-info"><i
                                        class="bi bi-eye"></i></a>
                                                ...
                                                <div class="modal-content p-2">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel"> Edit
                                                            admin <?php echo e($a->nama_lengkap); ?></h1>
                                                        <button type="button" class="btn-close"
                                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post"
                                                            action=<?php echo e(Route('admin.update', $a->id)); ?>>
                                                            <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-secondary"
                                                            data-bs-dismiss="modal">Batal</button>
                                                        <a href=<?php echo e(Route('admin.delete', $a->id)); ?>
...
<?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/admin/admin-page/index.blade.php ENDPATH**/ ?>