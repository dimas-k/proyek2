...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Dosen | Desain Industri | Edit</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('dosen.desainindustri.edit.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
</html><?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/dosen/desainindustri/edit/index.blade.php ENDPATH**/ ?>