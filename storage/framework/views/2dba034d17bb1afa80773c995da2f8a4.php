                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action=<?php echo e(Route('dsn.update.profil', auth()->user()->id)); ?> enctype="multipart/form-data"
                                method="post">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    id=""name="nama_lengkap" value="<?php echo e(auth()->user()->nama_lengkap); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    id="" name="no_telepon" value="<?php echo e(auth()->user()->no_telepon); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    id="" name="email" value="<?php echo e(auth()->user()->email); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    id="" name="nip" value="<?php echo e(auth()->user()->nip); ?>">
                                                <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                    id="" value="<?php echo e(auth()->user()->username); ?>"
                                                    name="username">
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/dosen/profil/edit/content.blade.php ENDPATH**/ ?>