<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <!-- sidebar-toggle-->
            <a class="logo-horizontal " href="/umum/dashboard">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            ...
                                            <small class="text-muted"><?php echo e(auth()->user()->kerjaan); ?></small>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item" href=<?php echo e(route('umum.profil.lihat')); ?>>
...
</div><?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/layout/header.blade.php ENDPATH**/ ?>