...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Umum | Paten | Edit</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('umum.paten.edit.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
</html><?php /**PATH D:\POLITEKNIK NEGERI INDRAMAYU\proyek2\resources\views/umum/paten/edit/index.blade.php ENDPATH**/ ?>