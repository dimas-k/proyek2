...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Checker | Lihat Data Paten</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!-- app-Header -->
            <?php echo $__env->make('checker.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /app-Header -->

            <!--APP-SIDEBAR-->
            <?php echo $__env->make('checker.layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <!--app-content open-->
            <?php echo $__env->make('checker.cekpaten.lihat.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
        ...
        <!-- FOOTER -->
        <?php echo $__env->make('checker.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- FOOTER END -->
...
</html><?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/checker/cekpaten/lihat/index.blade.php ENDPATH**/ ?>