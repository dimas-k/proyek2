        ...
        <div class="p-4 mt-3">
            ...
            <div class="table-responsive p-2">
                <table class="table table-borderless ">
                    ...
                    <tr>
                        <th>Abstrak Paten</th>
                        <td>: <a href=<?php echo e(asset('storage/' . $paten->abstrak_paten)); ?> class=""
                                target="_blank">Lihat Abstrak Paten</a></td>
                    </tr>
                    <tr>
                        <th>Deskripsi Paten</th>
                        <td>: <a href=<?php echo e(asset('storage/' . $paten->deskripsi_paten)); ?> class=""
                                target="_blank">Lihat Deskripsi Paten</a></td>
                    </tr>
                    <tr>
                        <th>Gambar Paten</th>
                        <td>: <a href=<?php echo e(asset('storage/' . $paten->gambar_paten)); ?> class=""
                                target="_blank">Lihat Gambar paten</a></td>
                    </tr>
                    <tr>
                        <th>Gambar Tampilan</th>
                        <td>: <a href=<?php echo e(asset('storage/' . $paten->gambar_tampilan)); ?> class=""
...
<?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/patenshow/index.blade.php ENDPATH**/ ?>