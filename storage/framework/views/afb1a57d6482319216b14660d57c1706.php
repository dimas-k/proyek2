...
<head>
    ...
    <!-- TITLE -->
    <title>SIKI POLINDRA | Dosen | Edit Paten</title>
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--app-content open-->
            <?php echo $__env->make('checker.cekpaten.nilai.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--app-content close-->
...
</html><?php /**PATH D:\coolyeah\proyek_ki_polindra\proyek2\resources\views/checker/cekpaten/nilai/index.blade.php ENDPATH**/ ?>