                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless p-1">
                                    ...
                                    <tr>
                                        <th>KTP</th>
                                        <td>:
                                            <a href="{{ route('private_paten_umum', ['file' => basename($paten->ktp_inventor)]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>:
                                            @if ($paten->data_pengaju2)
                                                <a href="{{ route('private_paten_umum', ['file' => basename($paten->data_pengaju2)]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>: <a href="{{ route('private_paten_umum', ['file' => basename($paten->pengalihan_hak)])  }}"
                                                target="_blank">Lihat Pengalihan Hak Invensi</a></td>
                                    </tr>
                                    <tr>
                                        <th>Klaim</th>
                                        <td>: <a href="{{ route('private_paten_umum', ['file' => basename($paten->klaim)])  }}"
                                                target="_blank">Lihat Klaim</a></td>
                                    </tr>
                                    <tr>
                                        <th>Pernyataan Kepemilikan</th>
                                        <td>: <a href="{{ route('private_paten_umum', ['file' => basename($paten->pernyataan_kepemilikan)])  }}"
                                                 target="_blank">Lihat Pernyataan Kepemilikan</a></td>
                                    </tr>
                                    <tr>
                                        <th>Surat Kuasa</th>
                                        <td>: <a href="{{ route('private_paten_umum', ['file' => basename($paten->surat_kuasa)])  }}"
